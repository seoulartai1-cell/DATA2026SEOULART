/*
 * studio-sound.js: 내 소리를 데이터로 (학습 2단계 · 4차시)
 * -----------------------------------------------------------------------------
...
(function () {
  ...
  // 각 특징의 의미(시각화·설명용)
  const FEAT = {
    음량: ['#CFE0D6', '소리의 세기(RMS): 클수록 크게'],
    저음: ['#3A4F7A', '낮은 주파수 에너지: 둥둥/우르릉'],
    중음: ['#6E84B8', '가운데 주파수: 말소리·멜로디 영역'],
    고음: ['#93A4E8', '높은 주파수: 쉭/치/반짝임'],
    날카로움: ['#8FC0B5', '스펙트럼 무게중심: 높을수록 밝고 날카로움'],
    변화: ['#2FB6A8', '직전 순간 대비 변화량: 리듬·요동'],
    음높이: ['#E6F5A6', '가장 강한 주파수(Hz): 낮을수록 저음, 높을수록 고음'],
    깊이: ['#6E84B8', '코골이의 깊이(가정)'],
    규칙성: ['#8FC0B5', '숨의 규칙성: 높을수록 고른 리듬'],
    뒤척임: ['#93A4E8', '몸 뒤척임: 높을수록 불안한 잠']
  };
  const SERIES_FALLBACK = ['#CFE0D6', '#3A4F7A', '#6E84B8', '#93A4E8', '#8FC0B5', '#2FB6A8', '#E6F5A6', '#182F49'];
  ...
  function snoringSample() {
    ...
    $('#sample-story').innerHTML = '<span class="ic">🛏</span><div><b>아빠의 한 달 코골이: 30밤의 이야기</b><br>같은 코골이도 그날의 <b>상황</b>에 따라 달라져요:<br>• <b>야근</b>한 밤: 크고 깊지만 <b>불규칙·뒤척임↑</b>(고단함).<br>• <b>월급날</b>: 한결 편안하고 규칙적.<br>• <b>주말</b>: 늦잠으로 가장 <b>깊고 길게</b>.<br>• <b>아픈 날</b>: 코가 막혀 작고 거칠고 뒤척여요.<br><br>점 스튜디오에서 <b>색 = 상황</b>으로 칠하고 <b>음량 → 크기 · 뒤척임 → 진동</b>으로 매핑하면, 숫자 뒤의 ‘피로의 들썩임’과 ‘한 달의 리듬’이 보여요. “이 소리를 점으로 옮긴다면, 나는 아빠의 <b>무엇</b>을 보여주고 싶은가?”</div>';
